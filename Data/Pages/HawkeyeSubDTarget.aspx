<%@ Page Title="" Language="C#" MasterPageFile="~/Data/MasterPage/Site.master" AutoEventWireup="true" CodeFile="HawkeyeSubDTarget.aspx.cs" Inherits="HawkeyeSubDTarget" %>
    ...
    <script type="text/javascript">
        ...
        function fnUploadData() {
            if ($("#FileUploader").get(0).files.length == 0) {
                ...
                data.append("FileType", "1");   //1: SubD; 2: WS
