...
public partial class HawkeyeWSTarget : System.Web.UI.Page
{
    ...
    protected void btnDownloadTemplate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Scmd.CommandText = "[spSubdHawkeyeGetSWStoreTargetData]";
            ...
            string filename = "WS Store Target for " + ddlMonthYear.SelectedItem;

            XLWorkbook wb = new XLWorkbook();
            wb = AddWorkSheet(wb, dt, SkipColumn, "WS Store Target - " + ddlMonthYear.SelectedItem);
            try
            {
    ...
    private static XLWorkbook AddWorkSheet(XLWorkbook wb, DataTable dt, string[] SkipColumn, string Sheetname)
    {
        ...
        ws.Range(ws.Cell(trCntr + 1, 6), ws.Cell(k, 6)).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Center;
        ws.Range(ws.Cell(trCntr + 1, 7), ws.Cell(k, 7)).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
