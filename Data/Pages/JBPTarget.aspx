<%@ Page Title="" Language="C#" MasterPageFile="~/Data/MasterPage/Site.master" AutoEventWireup="true" CodeFile="JBPTarget.aspx.cs" Inherits="JBPData" %>
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.split("^")[0] == "0") {
                            ...
                            //$("#divErrorRptBody").html(result.split("^")[1]);
                            //$("#divErrorRpt").dialog({
                            //    modal: true,
                            //    title: "Error :",
                            //    width: '60%',
                            //    height: 500,
                            //    close: function () {
                            //        $("#divErrorRpt").dialog('destroy');
                            //    }
                            //});

                            //var ht = $("#divErrorRptBody").find("table").eq(0).height();
                            //$("#divErrortbl").css("max-height", 440 - (ht + 60));
                        }
                        else {
                            $("#ConatntMatter_divMsg").html(result.split("^")[1]);
                        }
